...
//    @AppStorage("profile") var profileData: Data? // Store the profile as JSON data
//    var body: some View {
//        NavigationView {
//            ZStack {
//                // Background color
...
//                    Spacer()
//                    
//                    // Dynamic logo for login/signup
//                    Image(isLoginMode ? "login" : "signup") // Replace with your asset names
//                        .resizable()
...
//                        if let profileJSON = try? JSONSerialization.data(withJSONObject: profile, options: []) {
